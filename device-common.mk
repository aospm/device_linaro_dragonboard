...
# audio.dbx.xml has to be become audio.$PRODUCT.xml on the device so that the audio HAL can find it
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/etc/audio.db845c.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio.db845c.xml \
